...
نظرًا لأن اعتمادات OAuth المُدمجة ليست في OmniRoute، فهي عبارة عن سجلات **apenas لـ \__OMNI_TOKEN_123_**. عندما تصل إلى OmniRoute من خادم بعيد (على سبيل المثال: `https://omniroute.meuservidor.com`)، تحصل Google على مصادقة عبر:
...
> 📝 مواصفات الميزات الكاملة متوفرة في [**OMNI_TOKEN_147**](docs/new-features/) (217 مواصفات تفصيلية)
