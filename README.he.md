...
<sub>📡 כל הסוכנים מתחברים דרך <code>http://localhost:20128/v1</code> או <code>http://cloud.omniroute.online/v1__OMNI_TOKEN_245, —limited one config מכסה</sub>
...
> 📝 מפרטי תכונה מלאים זמינים ב-[**OMNI_TOKEN_147**](docs/new-features/) (217 מפרטים מפורטים)
